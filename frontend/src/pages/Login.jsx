    ...
    <div style={s.page}>
      <div style={s.card}>
        <div style={s.header}>
          ...
          <p style={s.subtitle}>Sign in to your library account</p>
        </div>
        ...
        <p style={s.footer}>Don't have an account? <Link to="/register" style={s.footerLink}>Register</Link></p>
      </div>
    </div>
  );
}
...
const s = {
  ...
  btn: { padding: '13px', backgroundColor: '#f0c040', color: '#0f1117', border: 'none', borderRadius: '8px', fontSize: '15px', fontWeight: '700', cursor: 'pointer', marginTop: '4px', letterSpacing: '0.3px' },
